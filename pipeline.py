...
from estimator import estimator, estimator_2, estimator_3, estimator_4, estimator_5
...
for file in ["me_at_the_zoo.in", "trending_today.in", "videos_worth_spreading.in", "kittens.in"]:
    ...
    write_output(estimator_5(endpoints, videos, cache_capacity, nb_caches),INPUT_FILEPATH+".estimator5.out" )